...
- **Customer access** — visibility to customers ordering delivery in your area through the Munchappy app
- **Order transmission** — real-time delivery of customer orders directly to your kitchen
- **Payment processing** — secure end-to-end collection and disbursement via Stripe, with no separate processing fee
- **Tax handling** — Munchappy collects and remits applicable sales tax on all platform orders on your behalf
...
A member of our team will walk you through setup, menu configuration, and everything you need to start receiving orders.
...
- **Weekly payout** — earnings deposited via direct deposit for each completed week
- **Instant cashout** — access your available earnings at any time for a small disclosed fee
...
Questions? Contact us at **support@munchappy.com**.
